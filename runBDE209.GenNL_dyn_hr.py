...
runID = ['BDE209_GenNL_dyn_hr'] # output names 
...
emisfile = ['emissions_dyn_GenNL_hr.txt']*len(runID) # emission inventory ('Emissions/')
...
for i in range(0, len(runID)):
    ...
    m.output_dyn(filename = 'OUT', units = ['ng_per_m3'], netcdf = True, cpk = False)
